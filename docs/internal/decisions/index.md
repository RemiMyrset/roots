...
[MADR 4 minimal](https://adr.github.io/madr/) form. Each record is written
once: when a decision is reversed or superseded, write a new record that links
back. The only permitted edit to an accepted record is its Status line.
...
shows the shape a good record takes: context, the options considered, the
choice and why, and the consequences, good and bad.
