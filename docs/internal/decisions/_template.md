...
<!-- Status vocabulary: proposed | accepted | rejected | deprecated | superseded by [NNNN](./NNNN-slug.md)
     ...
     warrants the ceremony. -->

## Context and Problem Statement

What forces are at play? What problem prompted this decision, and what
constraints bound the answer? Write it so a reader two years from now
understands why the obvious alternative was not obvious at the time.
